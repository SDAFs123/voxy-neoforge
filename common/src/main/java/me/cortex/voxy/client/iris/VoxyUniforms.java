...
public class VoxyUniforms {
    ...
    public static void addUniforms(UniformHolder uniforms) {
        uniforms
                .uniform1i(PER_FRAME, "vxRenderDistance", ()->VoxyConfig.CONFIG.sectionRenderDistance)//In chunks
        ...
        if (IrisShaderPatch.IMPERSONATE_DISTANT_HORIZONS) {
            uniforms
                    ...
                    .uniform1i(PER_FRAME, "dhRenderDistance", ()->VoxyConfig.CONFIG.sectionRenderDistance*16)//In blocks
